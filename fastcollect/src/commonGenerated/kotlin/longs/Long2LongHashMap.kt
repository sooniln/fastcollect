...
public class Long2LongHashMap @JvmOverloads constructor(
    ...
    public constructor(map: Map<Long, Long>): this(map.size) {
        putAll(map)
    }
    ...
    private var _primitiveEntries: MutableEntrySet<MutableLong2LongMap.MutableEntry>? = null
    override val primitiveEntries: MutableEntrySet<MutableLong2LongMap.MutableEntry> get() {
    ...
    private fun putRehashing(keysArr: LongArray, valuesArr: LongArray, mask: Int, rotVal: Int, key: Long, value: Long) {
    ...
    private open inner class SlotIterator {
        val keysArr = this@Long2LongHashMap.keysArr
        private val mask = this@Long2LongHashMap.mask
        val valuesArr = this@Long2LongHashMap.valuesArr
    ...
    private inner class EntryIterator : SlotIterator(), MutableIterator<MutableLong2LongMap.MutableEntry> {
        ...
        override fun next(): MutableLong2LongMap.MutableEntry {
            nextSlot()
            return object : MutableLong2LongMap.MutableEntry {
