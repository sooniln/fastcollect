...
public class IntHashSet @JvmOverloads constructor(
    ...
    private fun addRehashing(keysArr: IntArray, mask: Int, pow2: Int, key: Int) {
        val emptyKey = emptyKey
    ...
    private fun Int.slot(mask: Int, pow2: Int): Int {
        return (this.hashCode() * PHI).rotateLeft(pow2) and mask
    }

    private fun Int.slotDistance(slot: Int, mask: Int, pow2: Int): Int {
