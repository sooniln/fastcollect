...
public class Int2DoubleHashMap @JvmOverloads constructor(
    ...
    public constructor(map: Map<Int, Double>): this(map.size) {
        putAll(map)
    }
    ...
    private var _primitiveEntries: MutableEntrySet<MutableInt2DoubleMap.MutableEntry>? = null
    override val primitiveEntries: MutableEntrySet<MutableInt2DoubleMap.MutableEntry> get() {
    ...
    private fun putRehashing(keysArr: IntArray, valuesArr: DoubleArray, mask: Int, key: Int, value: Double) {
