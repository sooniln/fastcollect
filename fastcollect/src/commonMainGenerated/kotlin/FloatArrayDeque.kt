...
public class FloatArrayDeque private constructor(array: FloatArray, size: Int) : AbstractMutableFloatList() {
    ...
    @get:JvmSynthetic
    @set:JvmSynthetic
    internal var ring: FloatArray = array
    ...
    @JvmSynthetic
    public inline fun forEachReverse(action: (Float) -> Unit) {
        val ring = ring
        val tail = head + size
        if (tail > ring.size) {
    ...
    private inner class ListIteratorImpl(private var position: Int) : MutableFloatListIterator() {
        ...
        private var ring = this@FloatArrayDeque.ring
        ...
        override fun hasNext(): Boolean = position < this@FloatArrayDeque.size

        override fun nextFloat(): Float {
            if (position >= this@FloatArrayDeque.size) throw NoSuchElementException()
            if (ring !== this@FloatArrayDeque.ring) throw ConcurrentModificationException()
        ...
        override fun add(element: Float) {
            ...
            ring = this@FloatArrayDeque.ring
    ...
    internal companion object {
        ...
        @JvmSynthetic
        internal fun wrap(array: FloatArray): FloatArrayDeque = FloatArrayDeque(array, array.size)
    }
}
