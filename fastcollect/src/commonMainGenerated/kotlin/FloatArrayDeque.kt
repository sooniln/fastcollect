...
public class FloatArrayDeque private constructor(array: FloatArray, size: Int = array.size) : AbstractMutableFloatList(), RandomAccess {
    ...
    public constructor(elements: FloatCollection) : this(if (elements is FloatList) elements.toFloatArray() else elements.toFloatArray())
    ...
    private fun addInternal(position: Int, element: Float): Int {
        val newSize = size + 1
        ensureCapacity(newSize)
    ...
    override fun traverser(): MutableFloatTraverser = ListTraverser(0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other is RandomAccess) {
            ...
            var i = 0
            while (it.hasNext()) {
                if (!(it.nextFloat() equalsBoxed this[i++])) return false
            }
        }
        return true
    }
    ...
    private inner class ListTraverser(position: Int) : MutableFloatListTraverser {
        private val ring = this@FloatArrayDeque.ring
        private var head: Int = this@FloatArrayDeque.head
