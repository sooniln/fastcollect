...
public fun  int2ByteMapOf(key: Int, value: Byte): Int2ByteMap = SingletonInt2ByteMap(key, value)
@JvmSynthetic
...
public fun  Int2ByteMap.isNotEmpty(): Boolean = size != 0

@JvmSynthetic

public fun <A : Appendable> Int2ByteMap.joinTo(buffer: A, separator: CharSequence = ", ", prefix: CharSequence = "", postfix: CharSequence = "", transform: ((Int2ByteMap.Entry) -> CharSequence)? = null): A {
...
@JvmOverloads
public fun  Int2ByteMap.joinToString(separator: CharSequence = ", ", prefix: CharSequence = "", postfix: CharSequence = ""): String {
    ...
    override val entries: Set<Map.Entry<Int, Byte>> = object : AbstractSet<Map.Entry<Int, Byte>>() {
        ...
        override fun iterator(): Iterator<Map.Entry<Int, Byte>> = object : Iterator<Map.Entry<Int, Byte>> {
            ...
            override fun next(): Map.Entry<Int, Byte> {
                val entry = it.next()
                return AbstractInt2ByteMap.SimpleEntry(entry.key, entry.value).asEntry()
            }
        }
    }
}
...
private class MutableInt2ByteMapWrapper(private val map: MutableInt2ByteMap) : AbstractMutableMap<Int, Byte>() {
    ...
    override val entries: MutableSet<MutableMap.MutableEntry<Int, Byte>> = object : AbstractMutableSet<MutableMap.MutableEntry<Int, Byte>>() {
        ...
        override fun iterator(): MutableIterator<MutableMap.MutableEntry<Int, Byte>> = object : MutableIterator<MutableMap.MutableEntry<Int, Byte>> {
            ...
            override fun next(): MutableMap.MutableEntry<Int, Byte> {
