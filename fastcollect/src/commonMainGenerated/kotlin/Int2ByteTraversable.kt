 ...
 *
 * ```kotlin
 * val traverser = int2ByteMap.traverser()
...
public interface Int2ByteTraverser: Traverser<Int2ByteMap.Entry> {
    ...
    @get:JvmSynthetic
    override val element: Int2ByteMap.Entry get() = AbstractInt2ByteMap.SimpleEntry(key, value)
}
/**
...
public inline fun  Int2ByteTraversable.traverse(
...
@JvmSynthetic
@OptIn(ExperimentalContracts::class)
public inline fun  Int2ByteTraversable.traverseKeys(
    action: (Int) -> Unit
) {
    contract { callsInPlace(action, InvocationKind.UNKNOWN) }
