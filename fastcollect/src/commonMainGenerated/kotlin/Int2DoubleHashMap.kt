...
public class Int2DoubleHashMap @JvmOverloads constructor(
    ...
    override val values: DoubleCollection get() {
        return _values ?:
            ...
            object : AbstractDoubleCollection() {
                ...
                override fun traverser(): DoubleTraverser = Traverser().asValueTraverser()
    ...
    override fun traverser(): MutableInt2DoubleTraverser = Traverser()
    ...
    private inner class EntryIterator: SlotIterator(), MutableIterator<MutableInt2DoubleMap.MutableEntry> {
        override fun next(): MutableInt2DoubleMap.MutableEntry {
            nextSlot()
            return object: MutableInt2DoubleMap.AbstractMutableEntry() {
    ...
    private inner class Traverser : MutableInt2DoubleTraverser {
        private val keysArr = this@Int2DoubleHashMap.keysArr
        private val valuesArr = this@Int2DoubleHashMap.valuesArr
        private val emptyKey = this@Int2DoubleHashMap.emptyKey
        private val mask = keysArr.size - 1
        ...
        override var value: Double
            get() {
                check(_key != emptyKey)
                @Suppress("UNCHECKED_CAST", "USELESS_CAST")
                return valuesArr[slot] as Double
            }
            set(value) {
                check(_key != emptyKey)
                if (keysArr !== this@Int2DoubleHashMap.keysArr) throw ConcurrentModificationException()
