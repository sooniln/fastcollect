...
public class Int2DoubleHashMap @JvmOverloads constructor(
    ...
    override fun getValue(key: Int): Double = findSlot(key, { slot -> valuesArr[slot] }, { throw NoSuchElementException() })

    @Suppress("UNCHECKED_CAST")
    override fun getOrDefault(key: Int, defaultValue: Double): Double = findSlot(key, { slot -> valuesArr[slot] }, { defaultValue })
    ...
    /**
     * Guaranteed to be as fast or faster than using [iterator] to iterate. Modifying the Int2DoubleHashMap while this
    ...
    internal class ReusableEntry(
        ...
        @Suppress("UNCHECKED_CAST")
        override val value: Double get() = valuesArr[slot]
    }
