...
public class Int2AnyHashMap<V> @JvmOverloads constructor(
    ...
    /**
     * Guaranteed to be as fast or faster than using [iterator] to iterate. Modifying the Int2AnyHashMap while this
     * method is ongoing is not supported and leads to undefined behavior.
     */
    @JvmSynthetic
    public inline fun forEach(action: (Int2AnyMap.Entry<V>) -> Unit) {
        val keysArr = keysArr
    ...
    private inner class MutableReusableEntry : MutableInt2AnyMap.AbstractMutableEntry<V>() {
    ...
    private inner class EntryIterator : MutableIterator<MutableInt2AnyMap.MutableEntry<V>> {
        private val entry = MutableReusableEntry()
