...
public class Long2FloatHashMap private constructor(@PublishedApi internal val map: Long2IntHashMap) : AbstractMutableLong2FloatMap() {
    ...
    override fun iterator(): MutableFastIterator<MutableLong2FloatMap.MutableEntry> = EntryIterator(map.iterator())
    ...
    private class EntryIterator(
        private val it: MutableFastIterator<MutableLong2IntMap.MutableEntry>
    ) : MutableFastIterator<MutableLong2FloatMap.MutableEntry>, MutableLong2FloatMap.MutableEntry {

        private var entry: MutableLong2IntMap.MutableEntry? = null
