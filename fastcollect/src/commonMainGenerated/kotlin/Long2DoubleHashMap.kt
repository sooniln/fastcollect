...
public class Long2DoubleHashMap @JvmOverloads constructor(
    ...
    override fun traverser(): MutableLong2DoubleTraverser = Traverser()
    ...
    private inner class EntryIterator: SlotIterator(), MutableIterator<MutableLong2DoubleMap.MutableEntry> {
        override fun next(): MutableLong2DoubleMap.MutableEntry {
            nextSlot()
            return object: MutableLong2DoubleMap.AbstractMutableEntry() {
    ...
    private inner class Traverser : MutableLong2DoubleTraverser {
        private val keysArr = this@Long2DoubleHashMap.keysArr
        private val valuesArr = this@Long2DoubleHashMap.valuesArr
        private val emptyKey = this@Long2DoubleHashMap.emptyKey
        private val mask = keysArr.size - 1
