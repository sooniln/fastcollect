...
public class Long2DoubleHashMap @JvmOverloads constructor(
    ...
    override fun getValue(key: Long): Double = findSlot(key, { slot -> valuesArr[slot] }, { throw NoSuchElementException() })

    @Suppress("UNCHECKED_CAST")
    override fun getOrDefault(key: Long, defaultValue: Double): Double = findSlot(key, { slot -> valuesArr[slot] }, { defaultValue })
