 ...
 */
public abstract class AbstractIntPriorityQueue(initialCapacity: Int = 0): IntCollection {
 ...
 */
public class IntPriorityQueue private constructor(private val descending: Boolean) : AbstractIntPriorityQueue() {
