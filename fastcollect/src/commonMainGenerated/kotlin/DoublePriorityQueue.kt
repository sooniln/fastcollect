...
public abstract class AbstractDoublePriorityQueue(capacity: Int): DoubleCollection {
    ...
    @get:JvmSynthetic
    @set:JvmSynthetic
    internal var heap: DoubleArray = if (capacity == 0) EMPTY_ARRAY else DoubleArray(capacity)
