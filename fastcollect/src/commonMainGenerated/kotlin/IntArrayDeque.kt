...
public class IntArrayDeque private constructor(array: IntArray, size: Int = array.size) : AbstractMutableIntList(), RandomAccess {
    ...
    private fun addInternal(position: Int, element: Int): Int {
        val newSize = size + 1
        ensureCapacity(newSize)
    ...
    override fun traverser(): MutableIntTraverser = ListTraverser(0)
    ...
    private inner class ListTraverser(position: Int) : MutableIntListTraverser {
        private val ring = this@IntArrayDeque.ring
        private var head: Int = this@IntArrayDeque.head
