...
public class Long2IntHashMap @JvmOverloads constructor(
    ...
    @JvmOverloads
    public constructor(map: Long2IntMap, defaultValue: Int = Int.MIN_VALUE): this(defaultValue = defaultValue) { putAll(map) }
    @JvmOverloads
    public constructor(map: Map<Long, Int>, defaultValue: Int = Int.MIN_VALUE): this(defaultValue = defaultValue) { putAll(map) }
    ...
    internal var valuesArr: IntArray = EMPTY_VALUE_ARRAY
    ...
    private fun shiftAndInsert(keysArr: LongArray, mask: Int, slot: Int, currKey: Long, newKey: Long, newValue: Int) {
        val valuesArr = valuesArr
    ...
    override operator fun iterator(): MutableIterator<MutableLong2IntMap.MutableEntry> = EntryIterator()

    /**
     * Guaranteed to be as fast or faster than using [iterator] to iterate. Modifying the Long2IntHashMap while this
     * method is ongoing is not supported and leads to undefined behavior.
     */
    @JvmSynthetic
    public inline fun forEach(action: (Long2IntMap.Entry) -> Unit) {
        val keysArr = keysArr
    ...
    internal class ReusableEntry(
        ...
        private val valuesArr: IntArray,
    ...
    private inner class EntryIterator : MutableIterator<MutableLong2IntMap.MutableEntry> {
        private val entry = MutableReusableEntry()
