...
public fun  long2LongMapOf(key: Long, value: Long): Long2LongMap = SingletonLong2LongMap(key, value)
@JvmSynthetic
...
public fun  Long2LongMap.isNotEmpty(): Boolean = size != 0

@JvmSynthetic

public fun <A : Appendable> Long2LongMap.joinTo(buffer: A, separator: CharSequence = ", ", prefix: CharSequence = "", postfix: CharSequence = "", transform: ((Long2LongMap.Entry) -> CharSequence)? = null): A {
...
@JvmOverloads
public fun  Long2LongMap.joinToString(separator: CharSequence = ", ", prefix: CharSequence = "", postfix: CharSequence = ""): String {
...
public fun  Long2LongMap.Entry.asEntry(): Map.Entry<Long, Long> = Long2LongMapEntryWrapper(this)
...
public fun  MutableLong2LongMap.asMap(): MutableMap<Long, Long> = MutableLong2LongMapWrapper(this)

public fun  MutableLong2LongMap.MutableEntry.asEntry(): MutableMap.MutableEntry<Long, Long> = MutableLong2LongMapEntryWrapper(this)
...
public abstract class AbstractLong2LongMap : Long2LongMap {
    ...
    public class SimpleEntry(override val key: Long, override val value: Long) : Long2LongMap.AbstractEntry()
}
...
private class SingletonLong2LongMap(
    ...
    override fun get(key: Long): Long = if (key equalsRaw this.key) value else Long.MIN_VALUE
    ...
    override val entries: Set<Map.Entry<Long, Long>> = object : AbstractSet<Map.Entry<Long, Long>>() {
        ...
        override fun iterator(): Iterator<Map.Entry<Long, Long>> = object : Iterator<Map.Entry<Long, Long>> {
            ...
            override fun next(): Map.Entry<Long, Long> {
                val entry = it.next()
                return AbstractLong2LongMap.SimpleEntry(entry.key, entry.value).asEntry()
            }
        }
    }
}

private class Long2LongMapEntryWrapper(
    private val entry: Long2LongMap.Entry
) : Map.Entry<Long, Long> {
    ...
    override val entries: MutableSet<MutableMap.MutableEntry<Long, Long>> = object : AbstractMutableSet<MutableMap.MutableEntry<Long, Long>>() {
        ...
        override fun iterator(): MutableIterator<MutableMap.MutableEntry<Long, Long>> = object : MutableIterator<MutableMap.MutableEntry<Long, Long>> {
            ...
            override fun next(): MutableMap.MutableEntry<Long, Long> {
                ...
                return object : MutableLong2LongMap.AbstractMutableEntry() {
                    override val key: Long = entryKey
                    override var value: Long = entryValue
                        set(value) {
                            map.put(key, value)
                            field = value
                        }
...
private class MutableLong2LongMapEntryWrapper(
    private val entry: MutableLong2LongMap.MutableEntry
