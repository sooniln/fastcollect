...
public class Int2ByteHashMap @JvmOverloads constructor(
    ...
    public constructor(map: Int2ByteMap): this() { putAll(map) }
    public constructor(map: Map<Int, Byte>): this() { putAll(map) }
    ...
    override operator fun iterator(): MutableFastIterator<MutableInt2ByteMap.MutableEntry> = FastEntryIterator()


    override fun foreach(action: IntByteConsumer) {
    ...
    private inner class FastEntryIterator: SlotIterator(), MutableFastIterator<MutableInt2ByteMap.MutableEntry>, MutableInt2ByteMap.MutableEntry {
        ...
        override fun equals(other: Any?): Boolean = other is Int2ByteMap.Entry && other.key equalsBoxed key && other.value equalsBoxed value
