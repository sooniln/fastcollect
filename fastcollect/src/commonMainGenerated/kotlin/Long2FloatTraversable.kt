 ...
 *
 * ```kotlin
 * val traverser = long2FloatMap.traverser()
...
public interface Long2FloatTraverser: Traverser<Long2FloatMap.Entry> {
    ...
    @get:JvmSynthetic
    override val element: Long2FloatMap.Entry get() = AbstractLong2FloatMap.SimpleEntry(key, value)
}
/**
...
public inline fun  Long2FloatTraversable.traverse(
...
@JvmSynthetic
@OptIn(ExperimentalContracts::class)
public inline fun  Long2FloatTraversable.traverseKeys(
    action: (Long) -> Unit
) {
    contract { callsInPlace(action, InvocationKind.UNKNOWN) }
