...
public object Hash {
    ...
    public fun fibonacciHash(k: Int): Int = ((k xor (k ushr 16)) * INT_PHI).reverseBytes()
    public fun fibonacciHash(k: Long): Int = (((k xor (k ushr 32)) * LONG_PHI) ushr 32).toInt().reverseBytes()
}
