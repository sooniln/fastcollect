...
internal class Long2FloatHashMap(
    ...
    override operator fun set(key: Long, value: Float) {
        put(key, value)
    }
    ...
    override val primitiveEntries: MutableSet<MutableLong2FloatMap.MutableEntry> by lazy {
        object : AbstractMutableSet<MutableLong2FloatMap.MutableEntry>() {
            override val size: Int get() = this@Long2FloatHashMap.size
            ...
            override fun iterator(): MutableIterator<MutableLong2FloatMap.MutableEntry> = EntryIterator<MutableLong2FloatMap.MutableEntry> { key, value -> Entry(key, value) }
            override fun clear() = this@Long2FloatHashMap.clear()
        }
    }
    ...
    override fun getValue(key: Long): Float {
        if (key == ZERO) {
    ...
    private inner class EntryIterator<T>(private val visitor: (Long, Float) -> T): MutableIterator<T> {
        private val keysArr = this@Long2FloatHashMap.keysArr
        private val valuesArr = this@Long2FloatHashMap.valuesArr
        private val arrayUsage = this@Long2FloatHashMap.arrayUsage
    ...
    private inner class Entry(override val key: Long, value: Float) : MutableLong2FloatMap.MutableEntry {
