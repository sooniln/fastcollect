...
public fun mutableDoubleDequeOf(): DoubleArrayDeque = DoubleArrayDeque()
public fun mutableDoubleDequeOf(vararg elements: Double): DoubleArrayDeque = DoubleArrayDeque(elements)
