...
public class Int2LongHashMap(
    ...
    override val primitiveEntries: MutableEntrySet<MutableInt2LongMap.MutableEntry> by lazy {
    ...
    private inner class Entry(var _key: Int, var _value: Long) : MutableInt2LongMap.MutableEntry {
