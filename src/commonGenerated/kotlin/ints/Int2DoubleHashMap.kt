...
internal class Int2DoubleHashMap(
    ...
    override val primitiveEntries: MutableSet<MutableInt2DoubleMap.MutableEntry> by lazy {
        object : AbstractMutableSet<MutableInt2DoubleMap.MutableEntry>() {
            override val size: Int get() = this@Int2DoubleHashMap.size
            ...
            override fun iterator(): MutableIterator<MutableInt2DoubleMap.MutableEntry> = EntryIterator<MutableInt2DoubleMap.MutableEntry> { key, value -> Entry(key, value) }
            override fun clear() = this@Int2DoubleHashMap.clear()
        }
    }
    ...
    override fun getValue(key: Int): Double {
        if (key == ZERO) {
    ...
    private inner class EntryIterator<T>(private val visitor: (Int, Double) -> T): MutableIterator<T> {
        private val keysArr = this@Int2DoubleHashMap.keysArr
        private val valuesArr = this@Int2DoubleHashMap.valuesArr
        private val arrayUsage = this@Int2DoubleHashMap.arrayUsage
    ...
    private inner class Entry(override val key: Int, value: Double) : MutableInt2DoubleMap.MutableEntry {
