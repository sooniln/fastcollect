...
internal class Int2IntHashMap(
    ...
    override val primitiveEntries: MutableSet<MutableInt2IntMap.MutableEntry> by lazy {
        object : AbstractMutableSet<MutableInt2IntMap.MutableEntry>() {
            override val size: Int get() = this@Int2IntHashMap.size
            ...
            override fun iterator(): MutableIterator<MutableInt2IntMap.MutableEntry> = EntryIterator<MutableInt2IntMap.MutableEntry> { key, value -> Entry(key, value) }
    ...
    private inner class EntryIterator<T>(private val visitor: (Int, Int) -> T): MutableIterator<T> {
        private val keysArr = this@Int2IntHashMap.keysArr
        private val valuesArr = this@Int2IntHashMap.valuesArr
        private val arrayUsage = this@Int2IntHashMap.arrayUsage
    ...
    private inner class Entry(override val key: Int, value: Int) : MutableInt2IntMap.MutableEntry {
