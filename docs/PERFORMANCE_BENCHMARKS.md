...
![Map GetHit Time](map_gethit_cpu.svg)
...
![Map GetMiss Time](map_getmiss_cpu.svg)
...
![Map PutHit Time](map_puthit_cpu.svg)
...
![Map PutMiss Time](map_putmiss_cpu.svg)
...
![Set GetHit Time](set_gethit_cpu.svg)
...
![Set GetMiss Time](set_getmiss_cpu.svg)
...
![Set PutHit Time](set_puthit_cpu.svg)
...
![Set PutMiss Time](set_putmiss_cpu.svg)
...
| Library / Size |       3,000 |       12,000 |        48,000 |       192,000 |        768,000 |       3,072,000 |       12,288,000 |
|:---------------|------------:|-------------:|--------------:|--------------:|---------------:|----------------:|-----------------:|
| `fastcollect`  | `23.844 us` | `268.174 us` | `1359.444 us` | `6031.774 us` | `26041.652 us` | `114042.089 us` |  `701190.380 us` |
| `androidx`     | `41.213 us` | `164.800 us` |  `767.601 us` | `3302.401 us` | `80553.536 us` | `189265.787 us` |  `504493.110 us` |
| `fastutil`     |  `8.792 us` |  `37.916 us` |  `679.070 us` | `3049.085 us` | `13136.086 us` |  `58900.504 us` |  `373875.772 us` |
| `eclipse`      | `15.197 us` | `104.286 us` |  `871.935 us` | `3581.981 us` | `15268.933 us` |  `72650.657 us` |  `390901.965 us` |
| `kotlin`       | `23.328 us` | `169.832 us` | `1040.291 us` | `8240.300 us` | `43733.637 us` | `294413.839 us` | `1515049.110 us` |
| `hashsmith`    |  `8.898 us` |  `40.312 us` |  `682.087 us` | `2916.648 us` | `12974.048 us` |  `59915.440 us` |  `379250.042 us` |

### Iterate (iterate over every key/value pair in the map)

| Library / Size |      3,000 |      12,000 |       48,000 |       192,000 |        768,000 |      3,072,000 |      12,288,000 |
|:---------------|-----------:|------------:|-------------:|--------------:|---------------:|---------------:|----------------:|
| `fastcollect`  | `1.560 us` |  `6.869 us` |  `31.518 us` |  `500.242 us` |  `2089.214 us` |  `8219.810 us` |  `36232.088 us` |
| `androidx`     | `1.612 us` |  `6.179 us` |  `27.650 us` |  `539.335 us` |  `1837.727 us` |  `7282.886 us` |  `29012.609 us` |
| `fastutil`     | `1.598 us` | `21.214 us` |  `54.605 us` |  `510.230 us` |  `1934.884 us` |  `8570.861 us` |  `33732.965 us` |
| `eclipse`      | `2.881 us` | `11.246 us` | `297.236 us` | `1287.167 us` |  `5206.136 us` | `20946.149 us` |  `83973.319 us` |
| `kotlin`       | `7.249 us` | `31.885 us` | `470.826 us` | `2171.519 us` | `20895.942 us` | `94414.807 us` | `291421.750 us` |
| `hashsmith`    | `3.594 us` | `20.472 us` | `127.709 us` |  `672.565 us` |  `3372.320 us` | `61824.410 us` | `353890.260 us` |
