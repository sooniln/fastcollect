...
| `androidx`     | `3.822 ns` | `3.966 ns` | `4.207 ns` |  `6.467 ns` |  `8.144 ns` | `27.740 ns` |
...
| `androidx`     | `10.946 ns` | `4.878 ns` |  `8.071 ns` | `14.027 ns` | `18.980 ns` | `18.439 ns` |
...
| `androidx`     | `4.644 ns` |  `5.152 ns` |  `5.612 ns` | `10.455 ns` | `14.618 ns` | `44.043 ns` |
...
| `androidx`     |  `33.710 ns` |  `32.997 ns` |  `27.715 ns` |  `29.037 ns` |  `28.230 ns` |  `31.762 ns` |
...
| `androidx`     | `40.000 us` | `167.000 us` |  `800.000 us` | `3526.000 us` |   `15897.000 us` |  `82979.000 us` |
...
| `androidx`     | `2.000 us` |  `6.000 us` |  `26.000 us` |  `438.000 us` |  `2010.000 us` |  `7546.000 us` |
...
| `androidx`     | `1.000 us` |  `6.000 us` |  `23.000 us` |  `400.000 us` | `1687.000 us` |  `6913.000 us` |
...
| `androidx`     |  `1.000 us` |  `7.000 us` |  `24.000 us` |  `399.000 us` | `1698.000 us` |  `6888.000 us` |
...
| Library / Size |      3,000 |     12,000 |     48,000 |     192,000 |     768,000 |   3,072,000 |
|:---------------|-----------:|-----------:|-----------:|------------:|------------:|------------:|
| `fastcollect`  | `1.406 ns` | `1.462 ns` | `8.040 ns` |  `9.130 ns` | `10.275 ns` | `10.437 ns` |
...
| Library / Size |      3,000 |     12,000 |      48,000 |     192,000 |     768,000 |   3,072,000 |
|:---------------|-----------:|-----------:|------------:|------------:|------------:|------------:|
| `fastcollect`  | `3.813 ns` | `3.943 ns` | `12.816 ns` | `13.498 ns` | `18.496 ns` | `20.578 ns` |
...
| Library / Size |      3,000 |     12,000 |      48,000 |     192,000 |     768,000 |   3,072,000 |
|:---------------|-----------:|-----------:|------------:|------------:|------------:|------------:|
| `fastcollect`  | `2.581 ns` | `2.787 ns` | `10.005 ns` | `10.822 ns` | `12.525 ns` | `14.802 ns` |
...
| `androidx`     | `0.039 ms` | `0.161 ms` | `0.762 ms` | `3.448 ms` | `14.720 ms` |  `74.733 ms` |
